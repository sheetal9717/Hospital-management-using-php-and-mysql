<?php include('Ncheck.php') ?>


<html>
<head>
<link href="css/bootstrap.min.css" rel="stylesheet" id="bootstrap-css">
<link href="NurseRegistration.css" rel="stylesheet" id="bootstrap-css">
<script src="js/bootstrap.min.js"></script>
<script src="jquery-3.3.1.slim.js"></script>
<script src="NurseRegistration.js"></script>
</head>
<body>
	<div class="container">
				<form class="form-horizontal" role="form" method="POST" action="NurseRegistration.php">
					<h2>Nurse Registration</h2><br>
