...
<link href="Registration.css" rel="stylesheet" id="bootstrap-css">
	...
	<div class="container">
				<form class="form-horizontal" role="form" method="POST" action="registration.php">
					...
					<div class="form-group">
						...
						<div class="col-sm-9">
							<input type="phoneNumber" name="Phone_no" placeholder="Your Phone number" class="form-control" required >
						</div>
					</div>
